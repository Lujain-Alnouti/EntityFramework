<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Task1.aspx.cs" Inherits="EntityFrameWork22_1.Task1" %>
      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Insert Info</h3>
            ...
            <%--  <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                ...
                <asp:Button ID="Button1" runat="server" Text="Add" CssClass="btn btn-success btn-lg mb-1" OnClick="Button1_Click" />
